...
# LOAD JSON DATA
with open(r"C:\Users\shlok\Desktop\GenAI\GenAIProject\rag_model\travel_data.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
with open(r"C:\Users\shlok\Desktop\GenAI\GenAIProject\rag_model\travel_documents.txt", "w", encoding="utf-8") as f:
